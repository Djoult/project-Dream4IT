...
You must not use any part of the Materials on our Site for commercial purposes unless expressly permitted by us and/or, where applicable, from the relevant Owner.
</p>
          </li>
          <li>
            <h4>ACCEPTABLE USE</h4>
            <p>You may use our Site only for lawful purposes and we reserve the right, in our sole discretion, to terminate your use of the Site where you are in breach of these terms.
You are not permitted to use the Materials outside of the Site, save that you may use the recipes contained in the Site for your professional and domestic use as you see fit. You may not use our Site:
    ...
    To knowingly transmit any data, send or upload any material that contains viruses, Trojan horses, worms, time-bombs, keystroke loggers, spyware, adware or any other harmful programs or similar computer code designed to adversely affect the operation of any computer software or hardware (“Malicious Code”).
          ...
          <li>
            <h4>USER GENERATED CONTENT AND MODERATION</h4>
...
The views expressed by other users on our Site do not represent our views or values and are not endorsed by us. We expressly exclude our liability for any loss or damage arising from the use of any interactive service by a user in contravention of our Content Standards.
If a Site promotes or markets any Cocktail Club branded products or services, we reserve the right to moderate any user-generated content that is uploaded to such Site to ensure that our Content Standards and/or Content Guidelines are being adhered to. We reserve the right to remove any user-generated content that we consider (in our sole discretion) contravenes our Content Standards.
If you wish to complain about content uploaded by other users, please contact us on https://cocktailclub.com/service/contact
</p>
          </li>
          <li>
            <h4>UPLOADING MATERIAL TO OUR SITE</h4>
            <p>Where you submit your own content, images, photographs, recipes, videos, and any other materials (“Your Content”) to the Site, you hereby give us, and our group companies and business partners, a non-exclusive license to display Your Content on the Site, and to use Your Content for our own purposes (including for our own promotional purposes), and to allow other users to view, interact with, share and download Your Content. You acknowledge that given the nature of the Site, Your Content will be publicly visible and may be shared by third parties, and that even if you delete Your Content from the Site, it may still be visible to third parties who have already interacted with or shared Your Content. You shall ensure that you have all relevant permissions, rights and licenses to publish Your Content on the Site
...
We have the right to remove any material or posting you make on our Site if, in our sole opinion, such material does not comply with our Content Standards.
          ...
          <li>
            ...
            <p>Any and all material which you contribute to our Site must comply with the spirit, as well as the letter, of the following content standards and our Content Guidelines where applicable. These standards apply to each part of any contribution as well as to its whole.
...
This list only serves to provide examples and is not meant to be an exhaustive list.
          ...
          <li>
            <h4>CONTENT GUIDELINES FOR ALCOHOL RESPONSIBILITY</h4>
            <p>“Content” includes any contribution posted or made available by You on our Site, including, but not limited to, cocktail names, recipes, comments, pictures, videos, and any other materials. Any, and all Content which You contribute to the Site must comply with these Content Guidelines.

Content must adhere to the following:

    Anyone whose image or video is featured should be and look the age as required by local regulations (e.g., 25+ in the UK) and their express consent must be sought.
    ...
    If you are located in the US, do not reference names of, or website links to, legal entities and/or individuals that hold on-trade or off-trade alcohol beverage licenses in the US (“references” include, but are not limited to, statements, photographs, and videos).

Content should not display or condone:

    Activities that reward or encourage excessive or irresponsible consumption of alcohol, including but not limited to; underage consumption, drinking games, rapid or unsafe drinking, overconsumption, drunk driving.
    ...
    Illicit drugs.
    Rewarding oneself with alcohol, or consuming alcohol as a way to escape from something or overcome boredom, loneliness or other problems.
...
Alcoholic products/cocktails – Please endorse responsible consumption of alcoholic products and cocktails, and:
    ...
    We recommend you create cocktails with each serving containing a maximum of 1.5 ounces (or 45ml) of alcohol at 40% ABV or equivalent (for example 3 ounces of alcohol at 20% ABV).
...
For more on alcohol responsibility please visit http://www.responsibledrinking.org/ and https://www.responsibledrinking.eu/ or any official local alcohol responsibility site.
          ...
          <li>
            ...
            <p>Commentary and other materials posted on our Site are not intended to amount to advice on which reliance should be placed. We therefore disclaim all liability and responsibility arising from any reliance placed on such materials by any visitor to our Site, or by anyone who may be informed of any of its contents. We may help connect users offering their services (such as bar tending, service staff, mixology services) (“User Services”) with other users seeking to use such User Services. We do not vet or scrutinise any content offering User Services. You acknowledge that we do not supervise or monitor or moderate users offering User Services, and that we do not offer User Services. You agree that we are not liable or responsible in any way for User Services and that we do not endorse or recommend any particular User Services. Nothing in our relationship or these terms shall create any employment, agency, joint venture, partnership or other relationship between you and Cocktail Club / Quenched AS. We accept no responsibility for any liability arising in relation to the offer or receipt of any User Services and it is your responsibility to enter into contracts with other users as necessary to regulate such User Services.
You confirm that you have all licenses, qualifications and experience necessary to offer any User Services advertised or offered by you.
We may help you register or attend events organized by other members and connect with other members at such events. You agree that we are not responsible for such events, nor are we responsible for the conduct of other attendees at such events.
</p>
          </li>
          <li>
            <h4>OUR LIABILITY</h4>
            <p>The material displayed on our Site is provided “as is” and without any guarantees, conditions or warranties as to its accuracy, to the extent permitted by law, we and all other members of our Group of Companies and our affiliates (“Our Group”) hereby expressly exclude and disclaim:
All conditions, representations, or warranties of any kind, either express or implied, including warranties of merc hantability or fitness for a particular purpose and other terms which might otherwise be implied by statute, common law or the law of equity.
...
Nothing in these terms affects or limits your statutory rights as a consumer.
          ...
          <li>
            <h4>INFORMATION ABOUT YOU AND YOUR VISITS TO OUR SITE AND EVENTS</h4>
            <p>Your privacy is important to us. We process information about you in accordance with our Privacy Policy.
</p>
          </li>
          <li>
            <h4>MALICIOUS CODE, HACKING AND OTHER OFFENCES</h4>
...
We will not be liable for any loss or damage caused by a distributed denial-of-service attack or Malicious Code that may infect your computer equipment, computer programs, data or other proprietary material due to your use of our Site or to your downloading of any material posted on it, or on any website linked to it.
          ...
          <li>
            <h4>INDEMNITY</h4>
            <p>You will indemnify Our Group against any loss, damage or cost incurred by us arising out of your use of our Site, any User Services provided by you or accessible to you via the Site, any breach of these terms and conditions by you, or your violation of any other laws, regulations and rules. You will also indemnify us against any claims that information or material which you have submitted to us is in violation of any law or in breach of any third-party rights (including, but not limited to, claims in respect of defamation, invasion of privacy, breach of confidence and infringement of any intellectual property right). We reserve the right exclusively to defend and control any claims arising from the above and you will fully cooperate with us in any such defences.
</p>
          </li>
          <li>
            <h4>ENTIRE AGREEMENT</h4>
            <p>These terms of use, including our Privacy Policy and Cookie Policy constitute the entire agreement between you and us in relation to your use of our Site.
</p>
          </li>
          <li>
            <h4>JURISDICTION AND APPLICABLE LAW</h4>
            <p>Details of our internal complaint-handling system can be found here:
...
If you are located in the U.S., these terms are governed and construed in accordance with the laws of the State of New York, excluding its conflicts of law rules, and any dispute arising out of or relating to these Terms and Conditions of Website Use or your access or use of this Site will be subject to the exclusive jurisdiction of the courts located within the county of New York in the State of New York, and you hereby submit to the personal jurisdiction of such courts. If you are located anywhere except the U.S., then (i) these terms are governed by Norwegian law; and (ii) the Norwegian courts will have exclusive jurisdiction over any claim arising from, or related to, a visit to our Site although we retain the right to bring proceedings against you for breach of these terms in your country of residence or any other relevant country and (iii) these Terms and Conditions of Website Use are governed by Norwegianlaw.
</p>
          </li>
          <li>
            <h4>VARIATIONS</h4>
          ...
          <li>
            <h4>TRANSFERRING THIS AGREEMENT</h4>
            <p>We may transfer our rights and obligations under these terms to another organization. We will always tell you in writing if this happens and we will ensure that the transfer will not affect your rights under the contract.
</p>
          </li>
          <li>
            <h4>INFORMATION ABOUT US</h4>
            <p>In the present Terms and Conditions of Website Use and in the connected Cookie and Privacy Policies, “We” or “us” or “CC” or “CC/QAS” means Cocktail Club / Quenched AS with its registered office in Madserud Allé 34, 0274 Oslo, Norway.

If you have any concerns about material which appears on our Site or if </p>
          </li>
</ol>
  </p>
  </div>
