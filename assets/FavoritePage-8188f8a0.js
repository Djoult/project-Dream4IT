import{r as C,j as t,n}from"./index-0de1265b.js";import{T as u}from"./TitlePage-5bd2422f.js";import{E as f}from"./EllipsesLayout-fba67292.js";import{C as h}from"./CardTwo-2e67f2b5.js";import{L as k,C as v}from"./ListCardsTwo.styled-abb4d785.js";import{U as w,B as y,i as E}from"./Button Pagination-15465b3d.js";const T=({items:e})=>{const[a,i]=C.useState(e??[]),{firstContentIndex:o,lastContentIndex:r,nextPage:d,prevPage:p,page:c,setPage:x,totalPages:l}=w({contentPerPage:8,count:e.length}),m=s=>{const j=a.filter(P=>P._id.$oid!==s);i(j)},g=a.slice(o,r).map(s=>t.jsx(h,{...s,onDelete:m},s._id.$oid));return t.jsxs(t.Fragment,{children:[t.jsx(k,{children:g}),t.jsx(v,{children:t.jsx(y,{prevPage:p,totalPages:l,nextPage:d,page:c,setPage:x})})]})},B=n.div`
  position: relative;
  background: #0a0a11;
  margin: 0 auto;
`,F=n.div`
