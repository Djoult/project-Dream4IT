import{P as l,r as p,j as e,n as g,c as w,p as C,q as x}from"./index-d96dd00d.js";import{T as j}from"./TitlePage-db3ceed9.js";import{E as y}from"./EllipsesLayout-bd4d828b.js";import{C as E}from"./CardTwo-63772dad.js";import{L as T,C as k}from"./ListCardsTwo.styled-43cf5c4a.js";import{U as D,B as F}from"./Button Pagination-d50b9597.js";const m=({items:s,onDel:o})=>{const[i,c]=p.useState(9);p.useEffect(()=>{const n=()=>{window.innerWidth>1440?c(9):c(8)};return n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}},[]);const{firstContentIndex:d,lastContentIndex:t,nextPage:a,prevPage:r,page:f,setPage:h,totalPages:u}=D({contentPerPage:i,count:s.length}),P=async n=>{await o(n)},v=s.slice(d,t).map(n=>e.jsx(E,{...n,onDelete:P},n._id));return e.jsxs(e.Fragment,{children:[e.jsx(T,{children:v}),e.jsx(k,{children:e.jsx(F,{prevPage:r,totalPages:u,nextPage:a,page:f,setPage:h,pageType:"favorite"})})]})};m.propTypes={items:l.array,onDel:l.func};const L=g.div`
  position: relative;
  background: #0a0a11;
  margin: 0 auto;
`,S=g.div`
