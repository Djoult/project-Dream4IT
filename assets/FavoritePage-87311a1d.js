import{r as i,j as t,n as g,p as u}from"./index-3cecd6a4.js";import{T as C}from"./TitlePage-9a7623ab.js";import{E as v}from"./EllipsesLayout-08e065fd.js";import{C as k}from"./CardTwo-cef8d26d.js";import{L as E,C as w}from"./ListCardsTwo.styled-2c2febde.js";import{U as F,B as x}from"./Button Pagination-f98880cf.js";const T=({items:e})=>{const[o,a]=i.useState([]),{firstContentIndex:s,lastContentIndex:m,nextPage:r,prevPage:c,page:p,setPage:d,totalPages:l}=F({contentPerPage:8,count:e.length}),f=n=>{const j=o.filter(P=>P._id!==n);a(j)},h=e.slice(s,m).map(n=>t.jsx(k,{...n,onDelete:f},n._id));return t.jsxs(t.Fragment,{children:[t.jsx(E,{children:h}),t.jsxs(w,{children:[t.jsx(x,{namePage:"favorite",prevPage:c,totalPages:l,nextPage:r,page:p,setPage:d}),t.jsx(x,{prevPage:c,totalPages:l,nextPage:r,page:p,setPage:d,pageType:"favorite"})]})]})},y=g.div`
  position: relative;
  background: #0a0a11;
  margin: 0 auto;
`,B=g.div`
