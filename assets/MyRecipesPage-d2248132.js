import{r as p,j as e,n as i,c as x,q as l,u as m}from"./index-d920aa47.js";import{T as g}from"./TitlePage-fc156ff3.js";import{E as j}from"./EllipsesLayout-ef9e8413.js";import{C as u}from"./CardTwo-eb324ca9.js";import{L as h}from"./ListCardsTwo.styled-62b4cf26.js";const C=({items:t})=>{const[a,r]=p.useState(t??[]),o=s=>{const d=a.filter(c=>c._id.$oid!==s);r(d)},n=a.map(s=>e.jsx(u,{...s,onDelete:o},s._id.$oid));return e.jsx(e.Fragment,{children:e.jsx(h,{children:n})})},f=i.div`
  position: relative;
  background: #0a0a11;
  margin: 0 auto;
`,k=i.div`
