import{n as t,l as x,P as o,m,j as e,S as h,r as d,c as w,o as b,p as C}from"./index-dbe15efa.js";import{E as j}from"./EllipsesLayout-2d5f91fe.js";const c="/assets/hero-desktop-5baff696.jpg",y=t.section`
...
`,R=()=>{const i=m(),r=()=>{i("/drinks")};return e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"Craft Your Perfect Drink with Drink Master",description:`Unlock your inner mixologist with Drink Master, 
        ...
        and mastering the world's finest beverages. `}),e.jsxs(B,{children:[e.jsx(j,{}),e.jsxs(A,{children:[" ",e.jsx(p,{categoryDrink:"Punch/party drink"}),e.jsx(p,{categoryDrink:"Cocktail"}),e.jsx(p,{categoryDrink:"Shake"}),e.jsx(p,{categoryDrink:"Other/Unknown"}),e.jsx(T,{children:e.jsx(h,{onClick:r,children:"Other drinks"})})]})]})]})};export{A as Container,R as default};
